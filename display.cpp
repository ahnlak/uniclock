...
static uint_fast8_t               m_brightness_display;
...
void display_render( void )
{
  ...
  switch( m_display_mode )
  {
    case UC_DISPLAY_TIME:
      ...
      l_digit_offset = l_buffer[0] == '1' ? 1 : 0;
      m_graphics->character( l_buffer[0], pimoroni::Point( 10 + l_digit_offset, 2 ), 1 );
      l_digit_offset = l_buffer[1] == '1' ? 1 : 0;
      m_graphics->character( l_buffer[1], pimoroni::Point( 15 + l_digit_offset, 2 ), 1 );

      l_digit_offset = l_buffer[2] == '1' ? 1 : 0;
      m_graphics->character( l_buffer[2], pimoroni::Point( 22 + l_digit_offset, 2 ), 1 );
      l_digit_offset = l_buffer[3] == '1' ? 1 : 0;
      m_graphics->character( l_buffer[3], pimoroni::Point( 27 + l_digit_offset, 2 ), 1 );

      l_digit_offset = l_buffer[4] == '1' ? 1 : 0;
      m_graphics->character( l_buffer[4], pimoroni::Point( 34 + l_digit_offset, 2 ), 1 );
      l_digit_offset = l_buffer[5] == '1' ? 1 : 0;
      m_graphics->character( l_buffer[5], pimoroni::Point( 39 + l_digit_offset, 2 ), 1 );
